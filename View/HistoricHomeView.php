			...
			<div class='historicBoxes'>
				<div class='historicBox'>
					...
					<form method='post' action='historicVenues.php'>	
						<input class='historicHomeButtons' type='submit' value='".next($pageTexts)."' name='historicVenues'>
					</form>
				</div>
